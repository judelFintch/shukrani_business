  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Shukrani Business</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
...
s1.async=true;
s1.src='https://embed.tawk.to/637b38f4b0d6371309d02f8a/1giclcvop';
s1.charset='UTF-8';
